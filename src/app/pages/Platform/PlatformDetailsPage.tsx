...
import PlatformOriginators from './PlatformOriginator'
import PlatformLoans from './PlatformLoan'
...
const PlatformDetailsPage = (props: any) => {
  ...
  return (
    <>
      ...
      <Typography variant='h4'>Platform details</Typography>
      <Grid container spacing={2}>
        <Grid item xs={8}>
          <Card variant='outlined'>
            <CardContent>
              <Typography>Platform id: {platformDetails.id}</Typography>
              <Typography variant='h5' component='h3'>
                Contact:
              </Typography>
              <Typography>Contact id: {platformDetails.contact_id}</Typography>
              <Typography>
        ...
        <Grid item xs={4}>
          <Card variant='outlined'>
            <CardContent>
              <Typography>Category: {platformDetails.category}</Typography>
              <Typography>
              ...
              <Typography>Structure: {platformDetails.structure}</Typography>
              <Typography>Status: {platformDetails.status}</Typography>
              <Typography>
