...
export const Accounts = () => {
  ...
  useEffect(() => {
    if (currentState.accountsTable && currentState.accountsTable.entities) {
  ...
  useEffect(() => {
    if (currentState.singleAccount && currentState.singleAccount.entry) {
        ...
        <Card>
          <CardContent>
            <Grid container direction="column" alignItems="center">
              <Typography variant="h5">Only admin or contributors can enter here</Typography>
            </Grid>
          </CardContent>
        </Card>
      )}
