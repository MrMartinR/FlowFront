...
export const contactsSlice = createSlice({
    ...
    reducers: {
        ...
        userAccountSort: (state, action) => {
            ...
            if (areEmptyFields) {
                let entitiesOrdened = [...entities].sort(Util.sortCustom(field, isAsc, (a) => a.toUpperCase()));
        ...
        userAccountsAppend: (state, action) => {
            ...
            state.listLoading = false;
            state.error = null;
            state.contactsTable.entities = [...state.contactsTable.entities, ...entities];
        ...
        userAccountUpdated: (state, action) => {
            state.error = null;
            state.actionsLoading = false;
            state.contactsTable.entities = state.contactsTable.entities.map((entity) => {
