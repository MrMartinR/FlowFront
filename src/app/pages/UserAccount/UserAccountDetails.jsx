...
export const UserAccountsDetails = ({ selectedItemIndex, allTransactions = [], selectedUserAccount }) => {
  ...
  useEffect(() => {
    const currTransaction = allTransactions.filter((t) => t.user_account_id === selectedUserAccount.id)
