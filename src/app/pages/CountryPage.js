...
const CountryPage = (props) => {
  ...
  return (
    <>
    <CountryForm props={props.auth} setRows={setRows}/>
    <Paper className={classes.root}>
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            <StyledTableCell>Continent</StyledTableCell>
            <StyledTableCell align="right">ISO_Code</StyledTableCell>
        ...
        <TableBody>
          {rows.map(row => (
            <StyledTableRow key={row.id}>
              ...
              <StyledTableCell align="right">{row.iso_code}</StyledTableCell>
              <StyledTableCell align="right">{row.name}</StyledTableCell>
              <StyledTableCell align="right">{row.currency.symbol}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
